...
<MarkdownLayout headline="OIDC <strong>&nbspprotection&nbsp</strong> without OIDC code.">
    ...
    <br></br>
    <a href="/projects_media/security_layer/security_layer.pdf" class="text-center text-3xl flex items-center justify-center">Click here to view the guide!</a>
</MarkdownLayout>
